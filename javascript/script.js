...
function roundStart(){ //Sets up the html
	...
	$("#GamePage h1").text( strings["employer"] + ": " + bossName);
	$("#GamePage h2:first").html( strings["wanted"] + ": <strong>" + "<br>" + getJob() + "</strong>");

	var table = $("#pastQuals table");
	table.append("<tr><th><b>Designer</b></th><th><b>Genres</b></th><th><b>Features</b></th><th><b>Theme #1</b></th><th><b>Theme #2</b></th></tr>");
	...
	if(currentBoss == 0){
		$("#currentQuals h3").text( strings["applicant"] + ": " + pName(1));
	}else{
